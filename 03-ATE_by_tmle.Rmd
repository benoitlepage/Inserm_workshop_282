...
```{r Psi_ATE_tmle, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
rm(list = ls())
...
```{r Psi_ATE_tmle_package, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
rm(list = ls())
df <- read.csv2("data/df.csv")
...
```{r Psi_ATE_ltmle, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
...
```{r Psi_ATE_ltmle_iptw, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
