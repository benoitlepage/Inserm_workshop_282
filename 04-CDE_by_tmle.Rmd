...
```{r gcomp_ice_CDE, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
rm(list = ls())
...
```{r gcomp_ltmle, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
library(ltmle)
rm(list = ls())
df <- read.csv2("data/df.csv")
...
```{r Psi_CDE_MSM_IPTW2, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
...
```{r iptw_ltmle, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
library(ltmle)
rm(list = ls())
df <- read.csv2("data/df.csv")
...
### For binary outcomes
```{r Psi_CDE_ltmle_bin, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
rm(list = ls())
df <- read.csv2("data/df.csv")
...
```{r Psi_CDE_ltmle_bin2, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
summary(CDE_ltmle_M0_death, estimator = "iptw")
```

You can check which learner has been used:
```{r Psi_CDE_ltmle_bin3, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
...
```{r Psi_CDE_ltmle_cont, echo=TRUE, message=FALSE, warning=FALSE, eval = TRUE}
